...
<div class="container my-3">
     ...
     <div class="card mb-3" style="max-width: auto;">
          <div class="row g-0">
               <div class="col-md-6">
                    <img src="<?= base_url('img/avatar_1.jpg') ?>" class="img-fluid rounded mx-auto d-block" width="50%">
               </div>
               <div class="col-md-2">
                    <div class="card-body">
               ...
               <div class="col-md-4">
                    <div class="card-body">
                         <h4 class="card-title">: Khotiibul Umam</h4>
                         <p  class="card-text">: 23.240.0066</p>
                         <p  class="card-text">: 3P41</>
                         <p  class="card-text">: Teknik Informatika</p>
                         <p  class="card-text">: Teknik Informatika</p>
                         <p  class="card-text">: Ds. Bakalan, Kec. Kandeman, Kab. Batang</p>
                         <a  class="card-text" href="https://github.com/KhotibbulUmam"  target="_blank">: KhotibbulUmam</a>
